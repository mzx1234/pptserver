package com.gdut.pptserver.monitor;
...
import com.gdut.pptserver.constant.TaskTypeConstant.TaskType;
...
public class ExecutorManager {
    ...
    /**
     * 通过任务类型获取线程池对象。
     * @param taskType 任务类型{@link com.gdut.pptserver.constant.TaskTypeConstant.TaskType}
     * @return 相应的线程池对象。
     */
